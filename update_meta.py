...
repoList = [
    ("meta-browser", "master", "HEAD"),
    ("meta-clang", "kirkstone", "HEAD"),
    ("meta-cloud-services", "kirkstone", "HEAD"),
    ("meta-electron", "master", "HEAD"),
    ("meta-jumpnow", "dunfell", "HEAD"),
    ("meta-openembedded", "kirkstone", "HEAD"),
    ("meta-python2", "kirkstone", "HEAD"),
    ("meta-qt5", "kirkstone", "HEAD"),
    ("meta-raspberrypi", "kirkstone", "HEAD"),
    ("meta-security", "kirkstone", "HEAD"),
    ("meta-swupdate", "kirkstone", "HEAD"),
    ("meta-virtualization", "kirkstone", "HEAD"),
    ("meta-wandboard", "kirkstone", "kirkstone"),
    ("poky", "kirkstone", "HEAD")
]
