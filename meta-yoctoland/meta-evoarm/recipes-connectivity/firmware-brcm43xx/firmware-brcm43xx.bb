...
FILES:${PN} += "/etc/conf.d/bcm43xx"
FILES:${PN} += "/usr/bin/brcm_patchram_plus"
FILES:${PN} += "/lib/firmware/brcm/bcm4329.hcd"
FILES:${PN} += "/lib/firmware/brcm/bcm4330.hcd"
#FILES:${PN} += "/lib/firmware/brcm/brcmfmac4329-sdio.txt"
#FILES:${PN} += "/lib/firmware/brcm/brcmfmac4330-sdio.txt"
FILES:${PN} += "/usr/lib/systemd/scripts/brcm43xx-firmware-update"
FILES:${PN} += "/lib/systemd/system/brcm43xx-firmware.service"
FILES:${PN} += "/lib/systemd/system/brcm43xx.service"

SYSTEMD_SERVICE:${PN} = "brcm43xx-firmware.service"
SYSTEMD_SERVICE:${PN} = "brcm43xx.service"
